...
public class US206_Sifarish_Order {
    ...
    public void test001() {
        ...
        checkoutbtn2.click();
        System.out.println("checkout btn2 pressed");
        ...
        cardholderName.sendKeys("Team twelve");
        ...
        WebElement productName = driver.findElement(By.xpath("(//a[text()='14.1-inch Laptop'])[2]"));
        assertEquals("14.1-inch Laptop", productName.getText());
        System.out.println("Product Name asserted");

        WebElement creditcardtxt = driver.findElement(By.xpath("//li[@class='payment-method']"));
        assertEquals("Credit Card", creditcardtxt.getText());
        System.out.println("Credit Card txt asserted");

        WebElement price = driver.findElement(By.xpath("//span[@class='product-unit-price']"));
        double dprice = Double.parseDouble(price.getText().replaceAll("[^0-9.]", ""));
        double expectedprice = 1590.00;
        assertEquals(expectedprice, dprice,0.01);
        System.out.println("Price asserted");

        WebElement price2 = driver.findElement(By.xpath("//span[@class='product-subtotal']"));
        double dprice2 = Double.parseDouble(price2.getText().replaceAll("[^0-9.]", ""));
        assertEquals(expectedprice, dprice2 ,0.01);

        System.out.println("Price2 asserted");

        WebElement price3 = driver.findElement(By.xpath("(//span[@class='product-price'])[1]"));
        double dprice3 = Double.parseDouble(price3.getText().replaceAll("[^0-9.]", ""));
        assertEquals(expectedprice, dprice3,0.01);
        System.out.println("Price3 asserted");

        WebElement price4 = driver.findElement(By.xpath("(//td[@class='cart-total-right'])[4]"));
        double dprice4 = Double.parseDouble(price4.getText().replaceAll("[^0-9.]", ""));
        assertEquals(expectedprice,dprice4,0.01);
        System.out.println("Price4 asserted");
        ...
        WebElement successfullySms = driver.findElement(By.xpath("//*[text()='Your order has been successfully processed!']"));
        wait.until(ExpectedConditions.visibilityOf(successfullySms));
        assertTrue(successfullySms.isDisplayed());
        System.out.println("SuccessfullySms is displayed");
        assertEquals("https://demowebshop.tricentis.com/checkout/completed/",driver.getCurrentUrl());

        WebElement continuebtn4 = driver.findElement(By.xpath("//input[@value='Continue']"));
        continuebtn4.click();
        MyFunc.wait(2);
        System.out.println("Continue button pressed");
        gozleBagla();
